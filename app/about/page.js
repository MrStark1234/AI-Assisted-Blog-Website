          ...
          <div className="flex flex-col md:flex-row ">
            ...
            <div className="w-full md:w-2/3 flex flex-col justify-center  ">
              ...
              <p className="text-gray-600 dark:text-gray-50 text-lg mb-4">
                Hello! I'm Stark, a passionate software developer and tech
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">
              Stark's Journey as a Coder
            </h2>
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-50">
              From curious beginner to seasoned developer, here's how Stark
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center ">
              <div className="md:w-1/3">
                <img
                  src="https://media.licdn.com/dms/image/v2/C5612AQElU9G3huuS2g/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1583430239668?e=2147483647&v=beta&t=XbPGRFuIbBN7keY1DZxbJo6i5uOlAxhKInI2OTdLONA"
                  alt="Stark as a beginner"
              ...
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Stark’s coding journey began in high school when he stumbled
                  upon his first programming language—Python. What started as a
                  simple curiosity quickly turned into a passion, as Stark spent
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <img
                  src="https://randomtrees.com/blog/wp-content/uploads/2023/10/Code-generation.jpg"
                  alt="Stark learning new skills"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  After mastering the basics, Stark’s thirst for knowledge grew.
                  He began exploring more complex topics such as data
                  structures, algorithms, and web development. Enrolling in
                  online courses and attending coding bootcamps, Stark quickly
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <img
                  src="https://imageio.forbes.com/specials-images/imageserve/5f151e9faa78e50007ce7c76/0x0.jpg?format=jpg&height=600&width=1200&fit=bounds"
                  alt="Stark working on a big project"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  With several years of experience under his belt, Stark began
                  tackling more significant challenges. From contributing to
                  open-source projects to developing his own applications, Stark
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJlx5vHwJG8RJOUGJUAHRgLaRh_gYVRenicc8co8LBr1WcngIGHPZO7ZBJrgwYwrYclJQ&usqp=CAU"
                  alt="Stark mentoring others"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Today, Stark is not only a proficient coder but also a mentor
                  ...
                  development. For Stark, coding is more than just a
